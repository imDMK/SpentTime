...
public class ConfigurableGuiItemSerializer implements ObjectSerializer<ConfigurableGuiItem> {

    @Override
    public boolean supports(@NotNull Class<? super ConfigurableGuiItem> type) {
        return ConfigurableGuiItem.class.isAssignableFrom(type);
    }

    @Override
    public void serialize(@NotNull ConfigurableGuiItem item, @NotNull SerializationData data, @NotNull GenericsDeclaration generics) {
    ...
    @Override
    public ConfigurableGuiItem deserialize(@NotNull DeserializationData data, @NotNull GenericsDeclaration generics) {
        ...
        return ConfigurableGuiItem.builder()
                .material(material)
                .nameComponent(name)
                .loreComponent(lore)
                .slot(slot)
